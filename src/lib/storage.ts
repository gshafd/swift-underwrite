...
function seedIfEmpty(): Submission[] {
  ...
  const subs: Submission[] = [
    ...
    {
      id: "SUB-1009",
      brokerName: "Arthur J. Gallagher",
      insuredName: "Valley Express Logistics",
      operationType: "Delivery",
      primaryOperations: "Express Delivery",
      yearsInBusiness: 8,
      territories: ["CO", "UT"],
      documents: baseDocs,
      ...
      updatedAt: toISO(daysAgo(3)),
      status: "quoted",
      stages: makeStages({ withIntake: true, withRisk: true, withCoverage: true, withRate: true, withComms: true, vehicleCount: 7, score: 79, band: "B", premium: 9850 }),
    },
    {
      id: "SUB-1010",
      brokerName: "Alliant Insurance",
      insuredName: "Midwest Catering Solutions",
      operationType: "Food Service",
      primaryOperations: "Catering Services",
      yearsInBusiness: 3,
      territories: ["OH", "IN"],
      documents: baseDocs,
      ...
      updatedAt: toISO(daysAgo(2)),
      status: "declined",
      stages: makeStages({ withIntake: true, withRisk: true, withCoverage: false, withRate: false, withComms: false, vehicleCount: 4, score: 62, band: "C" }),
    },
    {
      id: "SUB-1011",
      brokerName: "Risk Strategies",
      insuredName: "Summit Construction Co",
      operationType: "Construction",
      primaryOperations: "General Contractor",
      yearsInBusiness: 18,
      territories: ["WY", "MT"],
      documents: baseDocs,
      ...
      updatedAt: toISO(daysAgo(1)),
      status: "issued",
      stages: makeStages({ withIntake: true, withRisk: true, withCoverage: true, withRate: true, withComms: true, vehicleCount: 15, score: 87, band: "A", premium: 21400 }),
    },
    {
      id: "SUB-1012",
      brokerName: "Marsh & Co.",
      insuredName: "Green Valley Waste Management",
      operationType: "Waste Management",
      primaryOperations: "Refuse Collection",
      yearsInBusiness: 22,
      territories: ["NV"],
      documents: baseDocs,
      createdAt: toISO(daysAgo(14)),
      updatedAt: toISO(daysAgo(14)),
      status: "declined",
      stages: makeStages({ withIntake: true, withRisk: true, withCoverage: false, withRate: false, withComms: false, vehicleCount: 25, score: 58, band: "C" }),
    },
    {
      id: "SUB-1013",
      brokerName: "Lockton",
      insuredName: "Pacific Coast Medical Supply",
      operationType: "Medical Delivery",
      primaryOperations: "Medical Equipment Transport",
      yearsInBusiness: 6,
      territories: ["OR", "WA"],
      documents: baseDocs,
      ...
      updatedAt: toISO(daysAgo(4)),
      status: "quoted",
      stages: makeStages({ withIntake: true, withRisk: true, withCoverage: true, withRate: true, withComms: true, vehicleCount: 9, score: 81, band: "A", premium: 12600 }),
    },
    {
      id: "SUB-1014",
      brokerName: "Brown & Brown",
      insuredName: "Desert Auto Parts LLC",
      operationType: "Parts Delivery",
      primaryOperations: "Auto Parts Distribution",
      yearsInBusiness: 14,
      territories: ["NM", "AZ"],
      documents: baseDocs,
      ...
      updatedAt: toISO(daysAgo(1)),
      status: "issued",
      stages: makeStages({ withIntake: true, withRisk: true, withCoverage: true, withRate: true, withComms: true, vehicleCount: 11, score: 83, band: "A", premium: 14750 }),
    },
    {
      id: "SUB-1015",
      brokerName: "Willis Towers Watson",
      insuredName: "City Cleaning Services",
      operationType: "Cleaning",
      primaryOperations: "Commercial Cleaning",
      yearsInBusiness: 5,
      territories: ["MA", "RI"],
      documents: baseDocs,
      createdAt: toISO(daysAgo(11)),
      updatedAt: toISO(daysAgo(11)),
      status: "processing",
      stages: makeStages({ withIntake: true, withRisk: true, withCoverage: true, withRate: false, withComms: false, vehicleCount: 6, score: 75, band: "B" }),
    },
  ];
